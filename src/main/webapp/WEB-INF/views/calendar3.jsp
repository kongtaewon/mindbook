...
<html lang="en">
  ...
  <head>
    ...
    <link rel="stylesheet" href='<%=request.getContextPath()%>/resources/fullcalendar/main.css'/sweetalert.css">
    
   
    <script '<%=request.getContextPath()%>/resources/fullcalendar/sweetalert.min.js"></script>
    <script>
            ...
            var calendar = new FullCalendar.Calendar(calendarEl, {
                ...
                events: [ 
                    ...
                    <%for (MdDTO DTO : calendarList) {%>
                    {
                        ...
                        start : '<%=DTO.getCALENDAR_START()%>',
                        end : '<%=DTO.getCALENDAR_END()%>',
